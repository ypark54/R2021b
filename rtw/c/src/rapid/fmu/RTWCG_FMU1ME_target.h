...
fmiStatus FMU1_initialize(void **fmuv,
                          unsigned char isToleranceUsed,
                          fmiReal toleranceValue);

fmiStatus FMU1_setTime(void **fmuv,
                       fmiReal time);

fmiStatus FMU1_completedIntegratorStep(void **fmuv,
                                       int8_T* hasStepEvent);

fmiStatus FMU1_setContinuousStates(void **fmuv,
                                   fmiReal states[],
                                   size_t nx);

fmiStatus FMU1_getContinuousStates(void **fmuv,
                                   fmiReal states[],
                                   size_t nx);

fmiStatus FMU1_getDerivatives(void **fmuv,
                              fmiReal derivatives[],
                              size_t nx);

fmiStatus FMU1_getEventIndicators(void **fmuv,
                                  fmiReal eventIndicators[],
                                  size_t nx);

fmiStatus FMU1_eventIteration(void **fmuv,
                              const char* blkPath,
                              fmiReal time);
...
fmiStatus FMU1ME_setRealVal(void **fmuv,
                            const fmiValueReference dvr,
                            size_t nvr,
                            const fmiReal dvalue);

fmiStatus FMU1ME_setReal(void **fmuv,
                         const fmiValueReference dvr,
                         size_t nvr,
                         const fmiReal value[]);

fmiStatus FMU1ME_getReal(void **fmuv,
                         const fmiValueReference dvr,
                         size_t nvr,
                         fmiReal value[]);

fmiStatus FMU1ME_setIntegerVal(void **fmuv,
                               const fmiValueReference dvr,
                               size_t nvr,
                               const fmiInteger dvalue);

fmiStatus FMU1ME_setInteger(void **fmuv,
                            const fmiValueReference dvr,
                            size_t nvr,
                            const fmiInteger value[]);

fmiStatus FMU1ME_getInteger(void **fmuv,
                            const fmiValueReference vr,
                            size_t nvr,
                            fmiInteger value[]);

fmiStatus FMU1ME_setBooleanVal(void **fmuv,
                               const fmiValueReference dvr,
                               size_t nvr,
                               const unsigned char dvalue);

fmiStatus FMU1ME_setBoolean(void **fmuv,
                            const fmiValueReference dvr,
                            size_t nvr,
                            const unsigned char value[]);

fmiStatus FMU1ME_getBoolean(void **fmuv,
                            const fmiValueReference dvr,
                            size_t nvr, unsigned char value[]);

fmiStatus FMU1ME_setString(void **fmuv,
                           const fmiValueReference dvr,
                           size_t nvr,
                           const fmiString value[]);

fmiStatus FMU1ME_setStringVal(void **fmuv,
                              const fmiValueReference dvr,
                              size_t nvr,
                              const fmiString);

fmiStatus FMU1ME_getString(void **fmuv,
                           const fmiValueReference vr,
                           size_t nvr,
                           fmiString value[]);
