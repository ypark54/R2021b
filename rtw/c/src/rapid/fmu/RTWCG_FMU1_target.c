...
fmiStatus FMU1_doStep(void **fmuv,
...
fmiStatus FMU1_setRealVal(void **fmuv,
...
fmiStatus FMU1_setReal(void **fmuv,
                       const fmiValueReference dvr,
                       size_t nvr,
                       const fmiReal value[]) {
    struct FMU1_CS_RTWCG * fmustruct = (struct FMU1_CS_RTWCG *)(*fmuv);
...
fmiStatus FMU1_getReal(void **fmuv,
                       const fmiValueReference dvr,
                       size_t nvr,
                       fmiReal value[]) {
    struct FMU1_CS_RTWCG * fmustruct = (struct FMU1_CS_RTWCG *)(*fmuv);
...
fmiStatus FMU1_setIntegerVal(void **fmuv,
                             const fmiValueReference dvr,
                             size_t nvr,
...
fmiStatus FMU1_setInteger(void **fmuv,
                          const fmiValueReference dvr,
                          size_t nvr,
...
fmiStatus FMU1_getInteger(void **fmuv,
                          const fmiValueReference dvr,
                          size_t nvr,
                          fmiInteger value[]) {
    struct FMU1_CS_RTWCG * fmustruct = (struct FMU1_CS_RTWCG *)(*fmuv);
...
fmiStatus FMU1_setBooleanVal(void **fmuv,
                             const fmiValueReference dvr,
                             size_t nvr,
...
fmiStatus FMU1_setBoolean(void **fmuv,
                          const fmiValueReference dvr,
                          size_t nvr,
...
fmiStatus FMU1_getBoolean(void **fmuv,
                          const fmiValueReference dvr,
                          size_t nvr,
                          unsigned char value[]) {
    struct FMU1_CS_RTWCG * fmustruct = (struct FMU1_CS_RTWCG *)(*fmuv);
...
fmiStatus FMU1_setStringVal(void **fmuv,
                            const fmiValueReference dvr,
                            size_t nvr,
...
fmiStatus FMU1_setString(void **fmuv,
                         const fmiValueReference dvr,
                         size_t nvr,
...
fmiStatus FMU1_getString(void **fmuv,
                         const fmiValueReference dvr,
                         size_t nvr,
                         fmiString value[]) {
    struct FMU1_CS_RTWCG * fmustruct = (struct FMU1_CS_RTWCG *)(*fmuv);
