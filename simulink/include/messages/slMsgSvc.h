...
struct __slmsg_MemPool_T
{
    ...
    /* The following 3 members are currently for string data type */
    int fPointerDataType;
    void* fDataTypeTable;
    ulong_T fNumElements;
    void(*fPointerConstruct)(void *p, void *data);
    void(*fPointerDestruct)(void *p, void *data);
    void(*fPointerCopy)(void *p, void *dst, const void *src);
