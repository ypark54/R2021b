...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
void slmsg_invokeSendData(SimStruct* S, void* hostPtr, void* fcnPtr, const void* data_to_send, int* status);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
void slmsg_invokeRecvData(SimStruct* S, void* hostPtr, void* fcnPtr, void* received_data, int* status);
