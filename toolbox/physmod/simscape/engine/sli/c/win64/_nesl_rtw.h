...
mIsOkayToUpdateMode)(const NeslSimulationData*);boolean_T*(*mCstateHasChanged)
(const NeslSimulationData*);void(*mDestroy)(NeslSimulationData*);
...
PMF_DEPLOY_STATIC boolean_T nesl_is_okay_to_update_mode(const
NeslSimulationData*sd){return*(sd->mIsOkayToUpdateMode(sd));}PMF_DEPLOY_STATIC
void nesl_set_cstate_has_changed(const NeslSimulationData*sd,boolean_T value){
*(sd->mCstateHasChanged(sd))=value;}PMF_DEPLOY_STATIC boolean_T
nesl_get_cstate_has_changed(const NeslSimulationData*sd){return*(sd->
mCstateHasChanged(sd));}PMF_DEPLOY_STATIC boolean_T nesl_has_sample_hits(const
NeslSimulationData*sd){size_t i;PmIntVector sample_hits=nesl_get_sample_hits(
sd);for(i=0;i<sample_hits.mN;i++){if(sample_hits.mX[i]){return true;}}return
false;}
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
boolean_T mPrecisionMet;}IterationsLogCore;typedef struct NeuDiagnosticTreeTag
...
extern "C" {
#endif /* __cplusplus */
typedef unsigned int NeDsEquationFlag;typedef unsigned int NeDsCERFlag;typedef
unsigned int NeDsICRFlag;typedef unsigned int NeDsVariableFlag;typedef struct
NeDsEquationDataTag{const char*mFullPath;size_t mIndex;NeDsEquationFlag mFlags
;NeEquationDomain mDomain;const char*mObject;size_t mNumRanges;size_t mStart;
boolean_T mIsSwitchedLinear;real_T mScale;const char*mUnit;}NeEquationData;
typedef struct NeDsCERDataTag{const char*mFullPath;size_t mIndex;NeDsCERFlag
mFlags;const char*mObject;size_t mNumRanges;size_t mStart;boolean_T mIsLinear;
}NeCERData;typedef struct NeDsICRDataTag{const char*mFullPath;size_t mIndex;
NeDsICRFlag mFlags;const char*mObject;size_t mNumRanges;size_t mStart;}
NeICRData;typedef struct NeVariableDataTag{const char*mFullPath;size_t mIndex;
NeDsVariableFlag mFlags;const char*mObject;real_T mScale;const char*mUnit;
real_T mICValue;boolean_T mIsDifferential;boolean_T mHasInitialRange;size_t mM
;size_t mN;NeInitMode mInitMode;const char*mDescription;}NeVariableData;
typedef struct NeObservableDataTag{const char*mFullPath;const char*mObject;
size_t mM;size_t mN;const char*mUnit;real_T mNominalValue;const char*
mNominalUnit;NeNominalSource mNominalSource;NeInitMode mInitMode;boolean_T
mIsDetermined;boolean_T mIsDifferential;NeFreqTimeType mFreqTimeType;boolean_T
mIsExternal;boolean_T mIsVariable;const char*mDescription;}NeObservableData;
typedef struct NeModeDataTag{const char*mFullPath;size_t mIndex;const char*
mObject;int32_T mICValue;const char*mDescription;}NeModeData;typedef enum
...
boolean_T mIsTop;}NeParameterData;typedef enum SscDiagnosticSettingTag{
...
SscLoggingSettingTag{SSC_LOGGING_INVALID= -1,SSC_LOGGING_NONE,SSC_LOGGING_ALL,
...
boolean_T mVariableStepSolver;boolean_T mIsUsingODEN;real_T mFixedStepSize;
real_T mStartTime;boolean_T mLoadInitialState;boolean_T mUseSimState;boolean_T
mLinTrimCompile;SscLoggingSetting mLoggingMode;real_T mRTWModifiedTimeStamp;
boolean_T mZcDisabled;};typedef struct NeParameterBundleTag{PmIntVector
...
ne_recreate_custom_data(const char*store,size_t len);typedef struct
NeStiffnessTag NeStiffness;typedef struct NeslSimulationSizesTag{size_t
...
NESL_SIM_REINIT,NESL_SIM_NUMJAC_DX_BOUNDS,NESL_NUM_SIMULATOR_METHODS}
...
NeslSimulator*s,const NeslSimulationData*sim_data,IterationsLogCore*il);void(*
mDestroy)(NeslSimulator*);NeCustomData*(*mGetCustomData)(const NeslSimulator*)
...
SscRTWLogFcnManagerObject*mRtwObject;};typedef struct NeProfilerTag NeProfiler
...
];size_t mNumRtpManagers;size_t mNumRtwLogFcnManagers;};typedef struct NeDaeTag
NeDae;PmfMessageId nesl_register_simulator_group(const char*key,const size_t
numDae,NeDae*const*dae,const NeSolverParameters*sp,const NeModelParameters*mp,
const size_t numOutputs,const NeOutputParameters*op,const size_t numRtpDaes,
const int*rtpDaes,const size_t numRtwLoggingDaes,const int*rtwLoggingDaes);
...
;struct NeslSimulatorGroupRegistryTag{void(*mInsert)(const
NeslSimulatorGroupRegistry*registry,const char*key,NeslSimulatorGroup*group);
void(*mErase)(const NeslSimulatorGroupRegistry*registry,const char*key);void(*
mEraseModel)(const NeslSimulatorGroupRegistry*registry,const char*model);
NeslSimulatorGroup*(*mLookup)(const NeslSimulatorGroupRegistry*registry,const
char*key);const NeslSimulator*(*mLeaseSimulator)(const
NeslSimulatorGroupRegistry*registry,const char*key,NeslSimulatorCategory cat,
size_t idx);const NeslRtpManager*(*mLeaseRtpManager)(const
NeslSimulatorGroupRegistry*registry,const char*key,size_t idx);const
SscRTWLogFcnManager*(*mLeaseRtwLogFcnManager)(const NeslSimulatorGroupRegistry
...
mDXCER_P;PmRealVector mIC;PmRealVector mICR;PmIntVector mICR_IM;PmBoolVector
mICR_ID;PmBoolVector mICR_IL;PmRealVector mDXICR;PmSparsityPattern mDXICR_P;
...
NE_DS_METHOD_DXCER_P,NE_DS_METHOD_IC,NE_DS_METHOD_ICR,NE_DS_METHOD_ICR_IM,
...
mNumICResiduals;size_t mNumModes;size_t mNumMajorModes;size_t mNumRealCache;
size_t mNumIntCache;size_t mNumObservables;size_t mNumObservableElements;
size_t mNumZcs;size_t mNumAsserts;size_t mNumAssertRanges;size_t
mNumParamAsserts;size_t mNumParamAssertRanges;size_t mNumInitialAsserts;size_t
mNumInitialAssertRanges;size_t mNumRanges;size_t mNumEquationRanges;size_t
mNumCERRanges;size_t mNumICRRanges;size_t mNumFundamentalSamples;size_t
...
mExpandFcn;NeDsExpandParamFcn mExpandParamFcn;NeDsRtpMapFcn mRtpMapFcn;
NeChecksum mChecksum;};PMF_DEPLOY_STATIC void ne_ds_release_reference(
NeDynamicSystem*dynSys){if(dynSys){dynSys->mReleaseReference(dynSys);}}
PMF_DEPLOY_STATIC void ne_ds_get_reference(NeDynamicSystem*dynSys){if(dynSys){
dynSys->mGetReference(dynSys);}}PMF_DEPLOY_STATIC int32_T ne_ds_call_method(
const NeDynamicSystem*dynSys,NeDsMethodId id,const NeDynamicSystemInput*input,
NeDsMethodOutput*output){return dynSys->mMethods[id](dynSys,input,output);}
PMF_DEPLOY_STATIC NeDsMethodOutput*ne_ds_default_output(const NeDynamicSystem*
dynSys,NeDsMethodId id,PmAllocator*allocator){return dynSys->mMakeOutput[id](
dynSys,allocator);}PMF_DEPLOY_STATIC NeDynamicSystemInputSizes
...
NeRealFunctorTag NeRealFunctor;typedef union NeDaeMethodOutputTag{
PmSparsityPattern mM_P;PmRealVector mM;PmSparsityPattern mDXM_P;PmRealVector
mDXM;PmSparsityPattern mDUM_P;PmRealVector mDUM;PmRealVector mF;
PmSparsityPattern mDXF_P;PmRealVector mDXF;PmSparsityPattern mDUF_P;
PmRealVector mDUF;PmSparsityPattern mDTF_P;PmRealVector mDTF;PmRealVector mY;
...
PmRealVector mOBS_ACT;PmRealVector mEQ_TOL;PmIntVector mSTIFF;PmRealVector
mNUMJAC_DX_LO;PmRealVector mNUMJAC_DX_HI;PmRealVector mSTIFF_IND;}
...
NeDae*,const NeSystemInput*,PmRealVector*,NeuDiagnosticManager*);void(*
...
NeCustomData*,const NeDae*,NeuDiagnosticManager*mgr);boolean_T mIsScalable;};
...
MC_SOLVER_LINEAR_INCONSISTENT,MC_SOLVER_STATUS_COUNT}McSolverStatus;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "ne_std.h"
...
(*mDestroy)(NeRealFunctor*functor);NeRealFunctorData*mData;};typedef struct
SscIniterTag SscIniter;typedef enum IniterTypeTag{INITER_TYPE_INVALID= -1,
INITER_TYPE_AC,INITER_TYPE_AC_DAE,INITER_TYPE_DAE,INITER_TYPE_COUNT}IniterType
;typedef struct SscComputeStateTag SscComputeState;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "string.h"
...
;};PMF_DEPLOY_STATIC void ssc_initer_assert_observable_match(const
NeObservableData*odataIniter,size_t numObservablesIniter,const NeObservableData
*odataSim,size_t numObservablesSim){size_t i=0;(void)odataIniter;(void)
numObservablesSim;if(odataSim){(void)0;;for(i=0;i<numObservablesIniter;++i){(
void)0;;(void)0;;(void)0;;}}}PMF_DEPLOY_STATIC void ssc_initer_get_reference(
SscIniter*initer){if(initer){++(initer->mRefCount);}}PMF_DEPLOY_STATIC void
ssc_initer_release_reference(SscIniter*initer){if(initer){(void)0;;if(--(
initer->mRefCount)==0){initer->mDestroy(initer);}}}typedef struct
NeStiffnessDataTag NeStiffnessData;struct NeStiffnessTag{NeStiffnessData*mData
;void(*mSetTimes)(NeStiffness*s,const PmRealVector*ts);PmRealVector*(*
mGetTimes)(NeStiffness*s);void(*mStart)(NeStiffness*s);void(*mSetState)(
NeStiffness*s,NeSystemInput*input);size_t(*mGetNumStates)(NeStiffness*s);
PmfMessageId(*mComputeStiffness)(NeStiffness*s,void*stiff,size_t k,
NeuDiagnosticManager*mgr);void(*mDestroy)(NeStiffness*s);};NeStiffness*
stiffness_create(NeDae*dae,SscComputeState*cs,NeSystemInputSizes*sizes);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_std.h"
...
SWL_NONLINEAR,NUM_CARDINALITY}ModeCardinality;typedef struct
GlobalMethodTableTag GlobalMethodTable;typedef union GmtMethodOutputTag{
PmIntVector mMODE;PmRealVector mY;PmRealVector mOBS;PmIntVector mASSERT;
PmIntVector mIASSERT;PmRealVector mINIT_R;PmIntVector mINIT_I;PmRealVector
mCACHE_R;PmIntVector mCACHE_I;PmRealVector mUPDATE_R;PmIntVector mUPDATE_I;
PmBoolVector mLOCK_R;PmBoolVector mLOCK_I;PmRealVector mUPDATE2_R;PmIntVector
mUPDATE2_I;PmBoolVector mLOCK2_R;PmBoolVector mLOCK2_I;PmIntVector mDP_L;
PmIntVector mDP_I;PmIntVector mDP_J;PmRealVector mDP_R;PmRealVector mINIT_DIFF
;PmRealVector mLOG;}GmtMethodOutput;typedef enum GmtMethodIdTag{
...
GMT_METHOD_DP_J,GMT_METHOD_DP_R,GMT_METHOD_INIT_DIFF,GMT_METHOD_LOG,
GMT_NUM_METHODS}GmtMethodId;typedef int32_T(*GmtMethod)(const GlobalMethodTable
*,const NeDynamicSystemInput*,GmtMethodOutput*);struct GlobalMethodTableTag{
...
mJNnz;boolean_T mIsLti;NeDynamicSystemInputSizes mSizes;SizeVectorPtr
mSelectors[NE_NUM_DYNAMIC_SYSTEM_INPUT_ID];PmIntVector*mStateIndices;
PmIntVector*mModeIndices;PmIntVector*mMRefIndices;PmIntVector*mQRefIndices;
boolean_T mIsModeBoolean;ModeCardinality mModeCardinality;};typedef struct
...
SscIniter*mIniter;SscIniter*mDaeIniter;void(*mDestroy)(SwitchedLinearSystem*
sls);};typedef struct SimulatorTag Simulator;typedef struct SimulatorDataTag
...
inputs,const PmRealVector*states,real_T time);void(*mRtwLogFcn)(const Simulator
*simulator,const NeDynamicSystemInput*input,PmRealVector*output);boolean_T(*
mSolve)(const Simulator*solver,const PmRealVector*inputs,const PmRealVector*
states,const PmRealVector*outputs,real_T time,void*st,const
NeuDiagnosticManager*mgr,boolean_T firstOutput);boolean_T(*mCheck)(const
Simulator*solver,const PmRealVector*inputs,const PmRealVector*states,real_T
time,const NeuDiagnosticManager*mgr);void(*mInitialize)(const Simulator*s,
SimulatorInitializeStartStatus start,SimulatorInitializeEndStatus end,void*rb)
;void(*mPushInfo)(const Simulator*s,IterationsLogCore*il);NeStiffness*(*
mGetStiffness)(const Simulator*s);void(*mDestroy)(Simulator*solver);};
...
NeObservableData*obsdata,const size_t numObservables,const DaemonChoice dc);
